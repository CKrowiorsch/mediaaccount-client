    ...
    where T : class
{
    ...
    /// </summary>
    /// <param name="apiKey">ApiKey der für den Abruf genutzt werden soll.</param>
    ...
    ArticleListScroll<T> CreateScroll(string apiKey, RequestDateType dateType, DateTime start, DateTime end, int batchSize, string? additionalParameters);
    ...
    Task<T?> GetByIdAsync(string apiKey, string id);
}